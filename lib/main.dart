    ...
    if (_locale == null) {
      ...
      return MaterialApp(
        ...
        routes: {
          ...
          RoutePaths.registerBuyer: (ctx) => const BuyerRegisterScreen(),
          ...
          RoutePaths.buyerDashboardController: (ctx) =>
              const BuyerDashboardController(),
          RoutePaths.addDemandScreen: (ctx) => const AddDemandScreen(),
          RoutePaths.sendOfferToFarmer: (ctx) =>
              const SendOfferToFarmerScreen(),
          RoutePaths.recentBidsBuyer: (ctx) => const RecentBidInfoBuyer(),
          RoutePaths.farmerDashboardController: (ctx) =>
