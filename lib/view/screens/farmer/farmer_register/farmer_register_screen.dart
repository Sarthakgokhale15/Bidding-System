  ...
  Future<void> gotoVerify() async {
    if (nameCtrl.text.length < 5) {
      ScaffoldMessenger.of(context)
          .showSnackBar(const SnackBar(content: Text("Enter Valid Name")));
      ...
      ScaffoldMessenger.of(context)
          .showSnackBar(const SnackBar(content: Text("Enter Valid address")));
      ...
      FarmerRegisterController farmerRegisterController =
